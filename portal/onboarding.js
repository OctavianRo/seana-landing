...
(() => {
  ...
  destination.searchParams.set('v', 'owner-portal-20260916-final');
  ...
  if (callback) {
    ...
    for (const key of [...params.keys()]) {
      if (/redirect_url$/.test(key)) params.set(key, destination.origin + destination.pathname + '?v=owner-portal-20260916-final');
    }
